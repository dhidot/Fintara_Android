...
class EditProfileViewModel(private val repository: CustomerRepository) : ViewModel() {
    ...
    fun updateMyProfile(request: CustomerUpdateProfileRequestDTO) {
        viewModelScope.launch {
            ...
            try {
                ...
                _isLoading.value = false // ✅ penting!
            }
        }
    }
}
